...
HighlightLoader = __decorate([ __param(0, Inject(DOCUMENT)),
...
HighlightJS = __decorate([ __param(1, Optional()), __param(1, Inject(HIGHLIGHT_OPTIONS)),
...
Highlight = __decorate([ __param(3, Optional()), __param(3, Inject(HIGHLIGHT_OPTIONS)),
